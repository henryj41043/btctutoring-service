...
describe('ContactsController', () => {
  ...
  describe('getContacts', () => {
    ...
    it('admin with view=summary lists the lean projection', async () => {
      await controller.getContacts(reqAs(admin), '', '', 'summary');
      expect(service.getContactsSummary).toHaveBeenCalled();
